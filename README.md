...
- Alexisbcook. (2022). [Titanic Tutorial](https://www.kaggle.com/code/alexisbcook/titanic-tutorial)
- Fatihardazengin. (2024). [Titanic Case with EDA and Prediction](https://www.kaggle.com/code/fatihardazengin/titanic-case-with-eda-and-prediction)
- Gusthema. (2023). [Titanic Competition w/ TensorFlow Decision Forests](https://www.kaggle.com/code/gusthema/titanic-competition-w-tensorflow-decision-forests)
- Iamalredygod. (2024). [Titanic Prediction (All Models)](https://www.kaggle.com/code/iamalredygod/titanic-prediction-all-models)
